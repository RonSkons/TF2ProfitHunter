...
Note: Dependent on [javax.json](https://docs.oracle.com/javaee/7/api/javax/json/package-summary.html). I've uploaded the JAR file of the library, but it must be manually added to the classpath in NetBeans (or your preferred IDE).
## Guide
